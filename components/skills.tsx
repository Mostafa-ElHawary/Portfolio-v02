...
export default function Skills() {
  ...
  return (
    <section
      id="skills"
      ref={ref}
      className="  flex flex-col  items-center  justify-center mb-28  scroll-mt-28 text-center sm:mb-40 mr-[1rem]   ml-[1rem] lg:mr-[15rem] lg:ml-[15rem] xl:mr-[20rem] xl:ml-[20rem]"
    >
