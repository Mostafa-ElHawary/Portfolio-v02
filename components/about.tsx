        ...
        <div className=" relative  ">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className=" h-34 w-34 m-auto mb-8 rounded-full object-cover border-[0.35rem] border-[#7984c4] border-opacity-30  dark:border-[#0249383b] dark:border-opacity-90 shadow-xl"
            ></Image>
            <motion.span
